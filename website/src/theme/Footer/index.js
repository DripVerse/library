        ...
        <div className="row">
          <div className="col md:w-1/4">
            ...
            <ul className="font-black list-reset text-24 text-yellow mt-50">
              {/* <li>
                <a
                  href="https://wallet.dripverse.org/"
              ...
              {/* <li>
                <a
                  href="https://explorer.dripverse.org/"
                  className="hover:text-white"
                >
                  Explorer
                </a>
              ...
              {/* <li>
                <a href="https://dev.dripverse.org/examples" className="hover:text-white">
                  Examples
                </a>
              </li> */}
              <li>
          ...
          <div className="col md:w-3/4 mt-50 md:mt-0" style={{ zIndex: "1" }}>
            <ul className="flex flex-wrap -mx-20 list-reset">
              ...
              <li className="mx-20">
                <a
                  href="https://twitter.com/0xDripVerse"
              ...
              <li className="mx-20">
                <a
                  href="https://github.com/DripVerse"
              ...
              {/* <li className="mx-20">
                <a
                  href="https://www.reddit.com/r/DripVerse"
                  className="block hover:text-reddit"
                  target="_blank"
                >
                  <span className="icon icon-36 ">
                    <svg
              ...
              <div className="col sm:w-1/3 mt-50">
                ...
                >
                  ...
                  <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-4719">
                    <a href="https://dripverse.org/bounties/">Bounties</a>
                  </li>
              ...
              <div className="col sm:w-1/3 mt-50">
                ...
                >
                  ...
                  {/* <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-400">
                    <a href="https://dripverse.org/backers/">Backers</a>
                  </li> */}
                  {/* <li className="menu-item menu-item-type-custom menu-item-object-custom menu-item-3490">
                    <a href="https://dripverse.org/downloads/dripverse_PressKit.zip">
                      Press Kit
                    </a>
                  </li> */}
